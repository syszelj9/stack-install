...
echo "This is a rewritten script!"
echo "If you need any help or have any questions, ask me on my discord OneDee#6679"
echo " "
sleep 10;
...
if [ "$EUID" -ne 0 ]
    then
    echo -e "[\e[31mFAIL\e[0m] The script was not run as root, run `sudo su` to enter root mode!"
    exit
else
